...
uint8_t mac[] = {0x04, 0xE9, 0xE5, 0x06, 0xDA, 0xBB}; //Dipende da ogni dispositivo, da trovare con T3_readmac.ino (Teensy) o generare (Arduino)
uint8_t ip[] = {10, 0, 0, 184};                       //This needs to be unique in your network - only one puzzle can have this IP
